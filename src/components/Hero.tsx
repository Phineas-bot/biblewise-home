      ...
      <div className="container relative mx-auto px-4 text-center md:text-left">
        <div className="mx-auto max-w-4xl md:mx-0">
          <h1 className="mb-5 text-3xl font-bold tracking-tight text-white sm:text-4xl md:text-5xl">
            Grow in Faith Through the Teachings of Prof. Z.T. Fomum
          </h1>
          ...
          <blockquote className="mb-8 border-l-4 border-bible-gold pl-4 italic text-white/85 md:mb-10">
            "The greatest need in the Church today is not for better methods, bigger buildings, more money, more preachers, but for better men and women, who know and love the Lord Jesus."
