    ...
    <section className="relative overflow-hidden py-12 md:py-20">
      ...
      <div className="container relative mx-auto px-4 text-center md:text-left">
        <div className="mx-auto max-w-4xl md:mx-0">
          ...
          <h2 className="mb-3 text-xl font-semibold text-white/90 sm:text-2xl">
            By Prof. Zacharias Tanee Fomum
          </h2>
          <p className="mb-4 text-lg text-white/90 md:text-xl max-w-2xl">
            A systematic Bible course designed to transform believers into faithful disciples who walk in the footsteps of Christ.
          </p>
          <blockquote className="mb-8 border-l-4 border-bible-gold pl-4 italic text-white/85 md:mb-10">
            "The greatest mark of the Holy Spirit in a person's life is not the power to perform miracles, but the power to walk like Jesus Christ day after day."
            <footer className="mt-2 text-sm text-white/75">— Prof. Zacharias Tanee Fomum</footer>
          </blockquote>
