...
const testimonials = [
  {
    ...
    testimonial: "The Christian Way Series transformed not only my personal walk with God but also equipped me to lead my congregation into deeper levels of commitment to Christ. Book 3 on sanctification particularly changed my life.",
  ...
  },
  {
    ...
    testimonial: "I've read many books on Christian living, but Prof. Fomum's practical approach in The Christian Way Series helped me establish concrete spiritual disciplines I was missing. His insights on prayer have been invaluable.",
  ...
  },
  {
    ...
    testimonial: "As someone working cross-culturally, the principles in The Way of Christian Character provided me with timeless wisdom that transcends cultural differences. This series should be required reading for every believer.",
  ...
  },
  {
    ...
    testimonial: "I've integrated Prof. Fomum's teachings from The Christian Way Series into our curriculum. The systematic progression through essential Christian doctrines and practices has given our students a solid foundation.",
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-bible-navy mb-2">Transformed Lives</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Hear from believers around the world whose spiritual journeys have been impacted by the teachings of Prof. Z.T. Fomum
          </p>
        </div>
                    ...
                    <CardContent className="p-6 md:p-8">
                      <div className="flex flex-col md:flex-row gap-6 items-center">
                        ...
                        <div className="md:w-3/4">
                          ...
                          <div>
                            <h4 className="font-semibold text-bible-navy">{testimonial.name}</h4>
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={cn(
                  ...
                  index === currentIndex ? "bg-bible-navy" : "bg-gray-300 hover:bg-gray-400"
                )}
