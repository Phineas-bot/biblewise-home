...
import { ChevronLeft, ChevronRight, Star, BookOpen, Award, CreditCard, BookMarked } from "lucide-react";
...
const upcomingBooks = [
  { id: 1, title: "The Way of Spiritual Power", availability: "Coming March 2024" },
  { id: 2, title: "The Way of Service", availability: "Coming May 2024" },
  { id: 3, title: "The Way of Spiritual Warfare", availability: "Coming July 2024" },
];
      ...
      <section className="py-12 bg-white border-t border-b border-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-bible-navy mb-3">Access The Christian Way Series</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Begin your spiritual journey with the first book for free, then continue with our flexible payment options
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {/* Free Course */}
            <div className="bg-bible-sand/20 rounded-lg p-6 border border-bible-gold/30 flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-semibold text-bible-navy mb-2">Start For Free</h3>
              <p className="text-gray-600 mb-4 flex-grow">Access "The Way of Salvation" completely free and begin your journey.</p>
            ...
            {/* Individual Books */}
            <div className="bg-white rounded-lg p-6 border border-bible-navy/20 shadow-sm flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-semibold text-bible-navy mb-2">Individual Books</h3>
              <p className="text-gray-600 mb-4 flex-grow">Purchase books individually as you progress through the series.</p>
            ...
            {/* Complete Series */}
            <div className="bg-bible-navy/5 rounded-lg p-6 border border-bible-navy/20 flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-semibold text-bible-navy mb-2">Complete Series</h3>
              <p className="text-gray-600 mb-4 flex-grow">Get access to all 12 books in The Christian Way Series at a discounted rate.</p>
              <div className="bg-gray-50 w-full p-3 rounded mb-4">
                <p className="font-medium text-bible-navy">$89.99 for all books</p>
                <p className="text-xs text-green-600 font-medium">Save 25% compared to individual purchase</p>
              </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-bible-navy mb-3">Coming Soon</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {upcomingBooks.map(book => (
              <div key={book.id} className="bg-white p-6 rounded-lg border border-gray-200 flex flex-col">
                <h3 className="font-semibold text-bible-navy mb-2">{book.title}</h3>
                <p className="text-gray-500 text-sm mb-4 flex-grow">{book.availability}</p>
                <Button variant="outline" size="sm" className="text-bible-blue border-bible-blue/30 hover:bg-bible-blue/10 mt-auto self-start">
                  Notify Me
                </Button>
              </div>
            ))}
